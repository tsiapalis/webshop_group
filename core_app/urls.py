...
from .views.checkout_view import DetailsView, ShippingView, PaymentView, PaymentConfirmationView
...
urlpatterns = [
    ...
    path('checkout/payment/confirmation/<int:order_number>/', PaymentConfirmationView.as_view(), name='payment_confirmation'),
